;(function() {
var ytl, underscore, json3, user_history_test, user_history_fixed_queue, user_history_exclude_offers, user_history_retargeting_offers, user_history_gender_account, user_history_gender_user, user_history_cost_account, user_history_cost_user, user_history_main, settings, jquery_var_deletedIds, jquery_var_document, jquery_var_slice, jquery_var_concat, jquery_var_push, jquery_var_indexOf, jquery_var_class2type, jquery_var_toString, jquery_var_hasOwn, jquery_var_support, jquery_core, jquery_sizzle, jquery_selector_sizzle, jquery_selector, jquery_var_rnotwhite, jquery_callbacks, jquery_deferred, jquery_core_var_rsingleTag, jquery_traversing_var_rneedsContext, jquery_traversing_findFilter, jquery_core_init, jquery_core_ready, jquery_support, jquery_data_support, jquery_data_var_acceptData, jquery_data, jquery_attributes_support, jquery_attributes_val, jquery_core_access, jquery_attributes_attr, jquery_attributes_prop, jquery_attributes_classes, jquery_attributes, jquery_var_pnum, jquery_css_var_rmargin, jquery_var_rcssNum, jquery_css_var_rnumnonpx, jquery_css_var_cssExpand, jquery_css_var_isHidden, jquery_css_var_swap, jquery_var_documentElement, jquery_css_support, jquery_css_curCSS = {}, jquery_css_adjustCSS, jquery_manipulation_var_rcheckableType, jquery_manipulation_var_rtagName, jquery_manipulation_var_rscriptType, jquery_manipulation_var_rleadingWhitespace, jquery_manipulation_var_nodeNames, jquery_manipulation_createSafeFragment, jquery_manipulation_support, jquery_manipulation_wrapMap, jquery_manipulation_getAll, jquery_manipulation_setGlobalEval, jquery_manipulation_buildFragment, jquery_traversing_var_dir, jquery_traversing_var_siblings, jquery_traversing, jquery_event_support, jquery_event, jquery_manipulation, jquery_css_defaultDisplay, jquery_css_addGetHookIf, jquery_css, jquery_css_hiddenVisibleSelectors, jquery_ajax_var_location, jquery_ajax_var_nonce, jquery_ajax_var_rquery, jquery_ajax_parseJSON, jquery_ajax, jquery_ajax_xhr, jquery_core_parseHTML, jquery_event_alias, jquery_ajax_load, jquery_dimensions, jquery_deprecated, jquery, loader_advertise, loader_main, models_advertise, models_params, render_bind_redirect, render_bind_slider, render_apply_css, text, tpl, tpl_templates_advBlockTemplatehtml, tpl_templates_advTemplatehtml, tpl_templates_advBlockNotFoundTemplatehtml, templates_main, render_main, loader_offers_log, loader, main;
(function () {
  ytl = function () {
  ...
  user_history_main = function (_, JSON, test, FixedQueue, ExcludeOffers, RetargetingOffers, GenderAccount, GenderUser, CostAccount, CostUser) {
    var prototype = 'prototype';
    var UserHistory = function () {
      ...
      this.cost_user = new CostUser();  // this.activity_accounts = new ActivityAccount();
  ...
  loader_advertise = function (jQuery, settings) {
    return function (obj) {
  ...
  render_apply_css = function (jQuery, _) {
    return function () {
  ...
  render_main = function (jQuery, redirect, slider, apply_css, templates) {
    return function (app) {
  ...
  loader = function (YottosLib, user_history, settings, loader, Advertise, Params, Render, Logger) {
    var Loader = function () {
