...
(function () {
  ...
  loader = function (YottosLib, user_history, settings, loader, Advertise, Params, Render) {
    var Loader = function () {
    ...
    return new Loader();
  }(ytl, user_history_main, settings, loader_main, models_advertise, models_params, render_main);
  (function (Loader) {
