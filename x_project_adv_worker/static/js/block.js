 ...
 */
define('user_history/test',['./../json3'], function (JSON) {
    return function () {
 ...
 * Created by kuzmenko-pavel on 13.04.17.
 */
define('user_history/fixed_queue',['./../underscore'], function (_) {
 ...
 * Created by kuzmenko-pavel on 13.04.17.
 */
define('user_history/exclude_offers',['./../underscore'], function (_) {
    var prototype = 'prototype';
 ...
 * Created by kuzmenko-pavel on 13.04.17.
 */
define('user_history/retargeting_offers',['./../underscore'], function (_) {
    var prototype = 'prototype';
 ...
 * Created by kuzmenko-pavel on 13.04.17.
 */
define('user_history/gender_user',['./../underscore'], function (_) {
    var prototype = 'prototype';
 ...
 * Created by kuzmenko-pavel on 13.04.17.
 */
define('user_history/cost_user',['./../underscore'], function (_) {
    var prototype = 'prototype';
...
define( 'jquery/var/deletedIds',[],function() {
	return [];
} );

define( 'jquery/var/document',[],function() {
	return window.document;
} );

define( 'jquery/var/slice',[
	"./deletedIds"
], function( deletedIds ) {
	return deletedIds.slice;
} );

define( 'jquery/var/concat',[
	"./deletedIds"
], function( deletedIds ) {
	return deletedIds.concat;
} );

define( 'jquery/var/push',[
	"./deletedIds"
], function( deletedIds ) {
	return deletedIds.push;
} );

define( 'jquery/var/indexOf',[
	"./deletedIds"
], function( deletedIds ) {
	return deletedIds.indexOf;
} );

define( 'jquery/var/class2type',[],function() {

	// [[Class]] -> type pairs
	return {};
} );

define( 'jquery/var/toString',[
	"./class2type"
], function( class2type ) {
	return class2type.toString;
} );

define( 'jquery/var/hasOwn',[
	"./class2type"
], function( class2type ) {
	return class2type.hasOwnProperty;
} );

define( 'jquery/var/support',[],function() {
...
// EXPOSE
if ( typeof define === "function" && define.amd ) {
	define('jquery/sizzle',[],function() { return Sizzle; });
...
define( 'jquery/selector',[ "./selector-sizzle" ], function() {} );

define( 'jquery/var/rnotwhite',[],function() {
	return ( /\S+/g );
} );

define( 'jquery/callbacks',[
	"./core",
	"./var/rnotwhite"
...
define( 'jquery/var/pnum',[],function() {
	return ( /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/ ).source;
} );

define( 'jquery/var/rcssNum',[
	"./pnum"
], function( pnum ) {
...
define( 'jquery/css/var/cssExpand',[],function() {
	return [ "Top", "Right", "Bottom", "Left" ];
} );

define( 'jquery/css/var/isHidden',[
	"../../core",
	"../../selector"
...
define( 'jquery/manipulation/var/rcheckableType',[],function() {
	return ( /^(?:checkbox|radio)$/i );
} );

define( 'jquery/manipulation/var/rtagName',[],function() {
	return ( /<([\w:-]+)/ );
} );

define( 'jquery/manipulation/var/rscriptType',[],function() {
	return ( /^$|\/(?:java|ecma)script/i );
} );

define( 'jquery/manipulation/var/rleadingWhitespace',[],function() {
	return ( /^\s+/ );
} );

define( 'jquery/manipulation/var/nodeNames',[],function() {
	return "abbr|article|aside|audio|bdi|canvas|data|datalist|" +
		"details|dialog|figcaption|figure|footer|header|hgroup|main|" +
		"mark|meter|nav|output|picture|progress|section|summary|template|time|video";
} );

define( 'jquery/manipulation/createSafeFragment',[
	"./var/nodeNames"
], function( nodeNames ) {
...
define( 'jquery/manipulation/support',[
	"../core",
	"../var/document",
	"../var/support"
...
define( 'jquery/manipulation/wrapMap',[
	"./support"
], function( support ) {
...
define( 'jquery/manipulation/getAll',[
	"../core"
], function( jQuery ) {
...
define( 'jquery/manipulation/setGlobalEval',[
	"../core"
], function( jQuery ) {
...
define( 'jquery/manipulation/buildFragment',[
	"../core",
	"./var/rcheckableType",
	"./var/rtagName",
	"./var/rscriptType",
...
define( 'jquery/data/var/acceptData',[
	"../../core"
], function( jQuery ) {
...
define( 'jquery/core/var/rsingleTag',[],function() {

	// Match a standalone tag
	return ( /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/ );
} );

define( 'jquery/traversing/var/rneedsContext',[
	"../../core",
	"../../selector"
], function( jQuery ) {
...
define( 'jquery/traversing/findFilter',[
	"../core",
	"../var/indexOf",
	"./var/rneedsContext",
	"../selector"
...
define( 'jquery/traversing/var/dir',[
	"../../core"
], function( jQuery ) {
...
define( 'jquery/traversing/var/siblings',[],function() {
...
define( 'jquery/css/defaultDisplay',[
	"../core",
	"../var/document",
...
define( 'jquery/css/var/rmargin',[],function() {
	return ( /^margin/ );
} );

define( 'jquery/css/var/rnumnonpx',[
	"../../var/pnum"
], function( pnum ) {
	return new RegExp( "^(" + pnum + ")(?!px)[a-z%]+$", "i" );
} );

define( 'jquery/css/var/swap',[],function() {
...
define( 'jquery/var/documentElement',[
	"./document"
], function( document ) {
	return document.documentElement;
} );

define( 'jquery/css/support',[
	"../core",
	"../var/document",
	"../var/documentElement",
	"../var/support"
...
define( 'jquery/css/addGetHookIf',[],function() {
...
define( 'jquery/attributes/support',[
	"../var/document",
	"../var/support"
], function( document, support ) {
...
define( 'jquery/attributes/classes',[
	"../core",
	"../var/rnotwhite",
	"../core/init"
], function( jQuery, rnotwhite ) {
...
define( 'jquery/ajax/var/location',[],function() {
	return window.location;
} );

define( 'jquery/ajax/var/nonce',[
	"../../core"
], function( jQuery ) {
	return jQuery.now();
} );

define( 'jquery/ajax/var/rquery',[],function() {
	return ( /\?/ );
} );

define( 'jquery/ajax/parseJSON',[
	"../core"
], function( jQuery ) {
 ...
 */
define('loader/advertise',['./../jquery', './../settings'], function (jQuery, settings) {
    return function (obj) {
        return jQuery.ajax(
 ...
 * Created by kuzmenko-pavel on 18.04.17.
 */
define('loader/main',['./../jquery', './../underscore', './advertise'],
 ...
 */
define('render/bind_redirect',['./../jquery', './../underscore'], function (jQuery, _) {
    "use strict";
    return function(el){
...
(function (factory) {
    define('animated/jquery.easing',['./../jquery'], function (jQuery) {
...
define('render/apply_css',['./../jquery', './../underscore'], function (jQuery, _) {
    return function (el) {
...
define("tpl!templates/advBlockTemplate.html", ["underscore"], function(_) { return function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div id="mainContainer">\n<div id=\'mainHeader\'>'+
((__t=( mainHeader ))==null?'':__t)+
'</div>\n<div id=\'adsContainer\'>'+
((__t=( ads ))==null?'':__t)+
'</div>\n<div id=\'mainFooter\'>'+
((__t=( mainFooter ))==null?'':__t)+
'</div>\n</div>';
}
return __p;
};});
...
define("tpl!templates/advTemplate.html", ["underscore"], function(_) { return function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='';
 for(var offer in offers) { 
__p+='\n<div data-id=\''+
((__t=( offers[offer].id ))==null?'':__t)+
'\' class=\''+
((__t=( offers[offer].style_class ))==null?'':__t)+
'\'>\n<div class=\'ellipsis multiline header\'>'+
((__t=( offers[offer].title ))==null?'':__t)+
'</div>\n<div class=\'ellipsis multiline description\'>'+
((__t=( offers[offer].description ))==null?'':__t)+
'</div>\n<div class=\'ellipsis cost\'>'+
((__t=( offers[offer].price ))==null?'':__t)+
'</div>\n<div class=\'imageCon\' data-image-id=\''+
((__t=( offers[offer].id ))==null?'':__t)+
'\' data-image-index=\''+
((__t=( offer ))==null?'':__t)+
...
__p+='\n<li><img src="'+
((__t=( offers[offer].images[image] ))==null?'':__t)+
'" alt=""/></li>\n';
 } 
__p+='\n</ul>\n</div>\n<div class="ellipsis button">'+
((__t=( offers[offer].button ))==null?'':__t)+
'</div>\n</div>\n';
 } 
__p+='';
}
...
define("tpl!templates/advBlockNotFoundTemplate.html", ["underscore"], function(_) { return function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<iframe width="'+
((__t=( w ))==null?'':__t)+
...
define("tpl!templates/advBlockPartnerTemplate.html", ["underscore"], function(_) { return function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<iframe width="'+
((__t=( w ))==null?'':__t)+
 ...
 * Created by kuzmenko-pavel on 18.04.17.
 */
define('render/main',['./../jquery', './bind_redirect', './bind_slider', './apply_css', './../templates/main'],
 ...
 * Created by kuzmenko-pavel on 18.04.17.
 */
define('loader/offers_log',['./../jquery', './../settings'], function (jQuery, settings) {
    var initial = 'initial';
