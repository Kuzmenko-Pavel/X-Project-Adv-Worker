;(function () {
    var ytl, underscore, json3, user_history_test, user_history_fixed_queue, user_history_exclude_offers,
        user_history_retargeting_offers, user_history_gender_user, user_history_cost_user, user_history_main, settings,
        jquery_var_deletedIds, jquery_var_document, jquery_var_slice, jquery_var_concat, jquery_var_push,
        jquery_var_indexOf, jquery_var_class2type, jquery_var_toString, jquery_var_hasOwn, jquery_var_support,
        jquery_core, jquery_sizzle, jquery_selector_sizzle, jquery_selector, jquery_var_rnotwhite, jquery_callbacks,
        jquery_deferred, jquery_queue, jquery_effects_support, jquery_var_pnum, jquery_var_rcssNum,
        jquery_css_var_cssExpand, jquery_css_var_isHidden, jquery_css_adjustCSS, jquery_core_access,
        jquery_manipulation_var_rcheckableType, jquery_manipulation_var_rtagName, jquery_manipulation_var_rscriptType,
        jquery_manipulation_var_rleadingWhitespace, jquery_manipulation_var_nodeNames,
        jquery_manipulation_createSafeFragment, jquery_manipulation_support, jquery_manipulation_wrapMap,
        jquery_manipulation_getAll, jquery_manipulation_setGlobalEval, jquery_manipulation_buildFragment,
        jquery_data_var_acceptData, jquery_core_var_rsingleTag, jquery_traversing_var_rneedsContext,
        jquery_traversing_findFilter, jquery_core_init, jquery_traversing_var_dir, jquery_traversing_var_siblings,
        jquery_traversing, jquery_event_support, jquery_data_support, jquery_data, jquery_event, jquery_manipulation,
        jquery_css_defaultDisplay, jquery_css_var_rmargin, jquery_css_var_rnumnonpx, jquery_css_var_swap,
        jquery_var_documentElement, jquery_css_support, jquery_css_curCSS = {}, jquery_css_addGetHookIf,
        jquery_core_ready, jquery_css, jquery_effects_Tween, jquery_effects, jquery_queue_delay,
        jquery_attributes_support, jquery_attributes_val, jquery_attributes_attr, jquery_attributes_prop,
        jquery_attributes_classes, jquery_attributes, jquery_ajax_var_location, jquery_ajax_var_nonce,
        jquery_ajax_var_rquery, jquery_ajax_parseJSON, jquery_ajax_parseXML, jquery_ajax, jquery_ajax_xhr,
        jquery_core_parseHTML, jquery_event_alias, jquery_ajax_load, jquery_dimensions, jquery_deprecated, jquery,
        loader_advertise, loader_main, models_advertise, models_params, render_bind_redirect, animated_jqueryeasing,
        render_bind_slider, render_apply_css, text, tpl, tpl_templates_advBlockTemplatehtml,
        tpl_templates_advTemplatehtml, tpl_templates_advBlockNotFoundTemplatehtml,
        tpl_templates_advBlockPartnerTemplatehtml, templates_main, render_main, loader_offers_log, loader, main;
    (function () {
        ytl = function () {
        ...
        }(underscore, json3, user_history_test, user_history_fixed_queue, user_history_exclude_offers, user_history_retargeting_offers, user_history_gender_user, user_history_cost_user);
        settings = {
            requiredData: {
                advertises: {
                    param: 'advertises',
        ...
        (function (window) {
            var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate,
                ...
                attributes = '\\[' + whitespace + '*(' + identifier + ')(?:' + whitespace + // Operator (capture 2)
                    '*([*^$|!~]?=)' + whitespace + // "Attribute values must be CSS identifiers [capture 5] or strings
                                                   // [capture 3 or capture 4]"
                    '*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|(' + identifier + '))|)' + whitespace + '*\\]',
                pseudos = ':(' + identifier + ')(?:\\((' + // To reduce the number of selectors needing tokenize in the preFilter, prefer
                                 // arguments:
            ...
            setDocument = Sizzle.setDocument = function (node) {
                ...
                sortOrder = hasCompare ? function (
                    ...
                    compare = (a.ownerDocument || a) === (b.ownerDocument || b) ? a.compareDocumentPosition(b) : // Otherwise we know they are
                                                                                   // disconnected
                        1;
                    // Disconnected nodes
            ...
            function elementMatcher(matchers) {
                return matchers.length > 1 ? function (
                    elem,
                    context,
                    xml
                ) {
        ...
        jquery_selector_sizzle = function (
            jQuery,
            Sizzle
        ) {
            jQuery.find = Sizzle;
        ...
        jquery_callbacks = function (
            ...
            function createOptions(options) {
                var object = {};
                jQuery.each(options.match(rnotwhite) || [], function (
                    _,
                    flag
                ) {
                    object[flag] = true;
        ...
        jquery_effects_support = function (
            support,
            document
        ) {
            (function () {
            ...
            return support;
        }(jquery_var_support, jquery_var_document);
            ...
            function adjustCSS(
                ...
                if (initialInUnit && initialInUnit[3] !== unit) {
                    ...
                    do {
                        ...
                        jQuery.style(elem, prop, initialInUnit + unit);  // Update scale, tolerating zero or NaN from
                                                                         // tween.cur() Break the loop if scale is
        ...
        jquery_manipulation_support = function (
            jQuery,
            document,
            support
        ) {
        ...
        jquery_manipulation_buildFragment = function (
            jQuery,
            rcheckableType,
            rtagName,
            rscriptType,
        ...
        jquery_traversing_findFilter = function (
            jQuery,
            indexOf,
            rneedsContext
        ) {
        ...
        jquery_core_init = function (
            ...
            var rootjQuery,
                ...
                rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, init = jQuery.fn.init = function (selector,
                                                                                                      context,
                                                                                                      root
                ) {
                    var match, elem;
        ...
        jquery_traversing_var_siblings = function (
            n,
            elem
        ) {
            var matched = [];
        ...
        jquery_data = function (
            ...
            function internalRemoveData(
                ...
                // Destroy the cache
                if (isNode) {
                    jQuery.cleanData([elem], true);  // Use delete when supported for expandos or `cache` is not a
        ...
        jquery_manipulation = function (
            ...
            var rinlinejQuery = / jQuery\d+="(?:null|\d+)"/g,
                ...
                rcleanScript = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, safeFragment = createSafeFragment(document),
            ...
            function cloneCopyEvent(
                ...
                var type, i, l, oldData = jQuery._data(src), curData = jQuery._data(dest, oldData),
            ...
            function fixCloneNodeIssues(
                ...
                if (nodeName === 'script' && dest.text !== src.text) {
                    ...
                    dest.defaultSelected = dest.selected = src.defaultSelected;  // IE6-8 fails to set the defaultValue
                                                                                 // to the correct value when cloning
                            ...
                            if (data) {
                                ...
                                if (cache[id]) {
                                    ...
                                    if (!attributes && typeof elem.removeAttribute !== 'undefined') {
                                        elem.removeAttribute(internalKey);  // Webkit & Blink performance suffers when
                                                                            // deleting properties from DOM nodes, so
        ...
        jquery_css_defaultDisplay = function (
            jQuery,
            document
        ) {
        ...
        jquery_effects_Tween = function (jQuery) {
            function Tween(
                elem,
                options,
                prop,
        ...
        jquery_effects = function (
            ...
            function defaultPrefilter(
                ...
                for (prop in props) {
                    ...
                    if (rfxtypes.exec(value)) {
                        ...
                        orig[prop] = dataShow && dataShow[prop] || jQuery.style(elem, prop);  // Any non-fx value stops
                                                                                              // us from restoring the
            ...
            jQuery.fn.extend({
                ...
                finish: function (type) {
                    ...
                    return this.each(function () {
                        var index, data = jQuery._data(this), queue = data[type + 'queue'],
            ...
            return jQuery;
        }(jquery_core, jquery_effects_support, jquery_var_rcssNum, jquery_var_rnotwhite, jquery_css_var_cssExpand, jquery_css_var_isHidden, jquery_css_adjustCSS, jquery_css_defaultDisplay);
        jquery_queue_delay = function (jQuery) {
        ...
        jquery_attributes_support = function (
            document,
            support
        ) {
            (function () {
        ...
        jquery_attributes_val = function (
            jQuery,
            support
        ) {
        ...
        jquery_attributes_attr = function (
            jQuery,
            access,
            support,
            rnotwhite
        ...
        jquery_attributes_prop = function (
            jQuery,
            access,
            support
        ) {
        ...
        jquery_attributes_classes = function (
            jQuery,
            rnotwhite
        ) {
            var rclass = /[\t\r\n\f]/g;
                                ...
                                for (conv2 in converters) {
                                    ...
                                    if (tmp[1] === current) {
                                        ...
                                        if (conv) {
                                            ...
                                            if (conv === true) {
                                                conv = converters[conv2];  // Otherwise, insert the intermediate
                                                                           // dataType
                                    ...
                                    if (callback && (isAbort || xhr.readyState === 4)) {
                                        ...
                                        if (isAbort) {
                                            ...
                                            if (!status && options.isLocal && !options.crossDomain) {
                                                status = responses.text ? 200 : 404;  // IE - #1450: sometimes returns
        ...
        jquery_core_parseHTML = function (
            jQuery,
            document,
            rsingleTag,
            buildFragment
        ...
        jquery_event_alias = function (jQuery) {
            jQuery.each(('blur focus focusin focusout load resize scroll unload click dblclick ' + 'mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave ' + 'change select submit keydown keypress keyup error contextmenu').split(' '), function (
                i,
                name
            ) {
                ...
                if (self.length > 0) {
                    jQuery.ajax({
                        ...
                        self.html(selector ? // If a selector was specified, locate the right elements in a dummy div
                            ...
                            jQuery('<div>').append(jQuery.parseHTML(responseText)).find(selector) : // Otherwise use
                                                                                                    // the full result
                ...
                if (req_type === 'advertises') {
                    ...
                    _.each(this.app.advertise.offers, function (offer) {
                        if (offer.id !== null) {
                            ...
                            if (complite) {
                                if (offer.retargeting) {
                                    this[app].uh[key[1]].add(offer.id, offer.unique_impression_lot);  //this[app].uh.retargeting_view.add(offer.id);
                                } else {
        ...
        (function (factory) {
            animated_jqueryeasing = function (jQuery) {
                return factory(jQuery);
            }(jquery);
        }(function (jQuery) {
            jQuery.easing['jswing'] = jQuery.easing['swing'];
            var pow = Math.pow, sqrt = Math.sqrt, sin = Math.sin, cos = Math.cos, PI = Math.PI, c1 = 1.70158,
                c2 = c1 * 1.525, c3 = c1 + 1, c4 = 2 * PI / 3, c5 = 2 * PI / 4.5;
        ...
        }(jquery, underscore, animated_jqueryeasing);
        render_apply_css = function (
            jQuery,
            _
        ) {
            return function (el) {
        ...
        text = function (module) {
            var text, fs, Cc, Ci, xpcIsWindows, progIds = [
                ...
                defaultPort = hasLocation && (location.port || undefined), buildMap = {},
            ...
            text = {
                ...
                parseName: function (name) {
                    var modName, ext, temp, strip = false, index = name.lastIndexOf('.'),
                ...
                load: function (
                    ...
                    var parsed = text.parseName(name),
                        ...
                        url = req.toUrl(nonStripName), useXhr = masterConfig.useXhr || text.useXhr;
                ...
                writeFile: function (
                    ...
                    var parsed = text.parseName(moduleName), extPart = parsed.ext ? '.' + parsed.ext : '',
            ...
            if (masterConfig.env === 'node' || !masterConfig.env && typeof process !== 'undefined' && process.versions && !!process.versions.node && !process.versions['node-webkit'] && !process.versions['atom-shell']) {
                ...
                text.get = function (
                    ...
                    var stringBuffer, line, encoding = 'utf-8', file = new java.io.File(url),
                    ...
                    try {
                        ...
                        // Note that when we use utf-8, the BOM should appear as "EF BB BF", but it doesn't due to this
                        // bug in the JDK: http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4508058
        ...
        tpl_templates_advBlockNotFoundTemplatehtml = function (_) {
            return function (obj) {
                ...
                with (obj || {}) {
                    __p += '<iframe width="' + ((__t = w) == null ? '' : __t) + '" height="' + ((__t = h) == null ? '' : __t) + '" frameborder="0"\n        marginwidth="0" marginheight="0" vspace="0"\n        hspace="0" allowtransparency="true"\n        scrolling="no" allowfullscreen="true"\n        style="left:0;position:absolute;\n        top:0;width:' + ((__t = w) == null ? '' : __t) + 'px;height:' + ((__t = h) == null ? '' : __t) + 'px;"\n        src="' + ((__t = src) == null ? '' : __t) + '"\n></iframe>';
                }
                return __p;
            };
        }(underscore);
        tpl_templates_advBlockPartnerTemplatehtml = function (_) {
            return function (obj) {
                var __t, __p = '', __j = Array.prototype.join, print = function () {
                    __p += __j.call(arguments, '');
                };
        ...
        }(tpl_templates_advBlockTemplatehtml, tpl_templates_advTemplatehtml, tpl_templates_advBlockNotFoundTemplatehtml, tpl_templates_advBlockPartnerTemplatehtml);
            ...
            return function (app) {
                ...
                render_obj.not_found = function () {
                    jQuery('body').html(templates.advBlockPartnerTemplate({
                        src: this.app.settings.not_found + '?scr=' + this.app.adsparams.block_id + '&w=' + this.app.params.w_w + '&h=' + this.app.params.w_h,
                ...
                render_obj.parther = function () {
                    jQuery('body').html(templates.advBlockPartnerTemplate({
                        src: this.app.settings.partners + '?scr=' + this.app.adsparams.block_id + '&w=' + this.app.params.w_w + '&h=' + this.app.params.w_h,
                        h: this.app.params.w_h,
                        w: this.app.params.w_w
                    }));
                };
        ...
        }(jquery, render_bind_redirect, render_bind_slider, render_apply_css, templates_main);
        loader_offers_log = function (
            jQuery,
            settings
        ) {
            var initial = 'initial';
            ...
            Logger.prototype.send = function () {
                jQuery.ajax(settings.requiredData.offer_log.url, {
        ...
        loader = function (
            ...
            return new Loader();
        }(ytl, user_history_main, settings, loader_main, models_advertise, models_params, render_main, loader_offers_log);
        (function (Loader) {
