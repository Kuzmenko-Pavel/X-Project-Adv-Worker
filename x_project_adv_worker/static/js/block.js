;(function () {
    var ytl, underscore, json3, user_history_test, user_history_fixed_queue, user_history_exclude_offers,
        user_history_retargeting_offers, user_history_gender_account, user_history_gender_user,
        user_history_cost_account, user_history_cost_user, user_history_main, settings, jquery_var_deletedIds,
        jquery_var_document, jquery_var_slice, jquery_var_concat, jquery_var_push, jquery_var_indexOf,
        jquery_var_class2type, jquery_var_toString, jquery_var_hasOwn, jquery_var_support, jquery_core, jquery_sizzle,
        jquery_selector_sizzle, jquery_selector, jquery_var_rnotwhite, jquery_callbacks, jquery_deferred, jquery_queue,
        jquery_effects_support, jquery_var_pnum, jquery_var_rcssNum, jquery_css_var_cssExpand, jquery_css_var_isHidden,
        jquery_css_adjustCSS, jquery_core_access, jquery_manipulation_var_rcheckableType,
        jquery_manipulation_var_rtagName, jquery_manipulation_var_rscriptType,
    ...
    (function () {
        ...
        }(underscore, json3, user_history_test, user_history_fixed_queue, user_history_exclude_offers, user_history_retargeting_offers, user_history_gender_account, user_history_gender_user, user_history_cost_account, user_history_cost_user);
        settings = {
            requiredData: {
                advertises: {
                    param: 'advertises',
